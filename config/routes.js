...
// Airline
apiRouter.get("/api/v1/airline", controllers.api.v1.authController.authorizeAdmin,controllers.api.v1.airlineController.list);
apiRouter.get("/api/v1/airline/:id", controllers.api.v1.authController.authorizeAdmin,controllers.api.v1.airlineController.checkAirline,controllers.api.v1.airlineController.getById);
apiRouter.post("/api/v1/airline", controllers.api.v1.authController.authorizeAdmin,controllers.api.v1.airlineController.create);
apiRouter.put("/api/v1/airline/:id",controllers.api.v1.authController.authorizeAdmin,controllers.api.v1.airlineController.checkAirline,controllers.api.v1.airlineController.update);
apiRouter.delete("/api/v1/airline/:id", controllers.api.v1.authController.authorizeAdmin,controllers.api.v1.airlineController.checkAirline,controllers.api.v1.airlineController.destroy);

// Airport
apiRouter.get("/api/v1/airport",controllers.api.v1.authController.authorizeAdmin ,controllers.api.v1.airportController.list);
apiRouter.get("/api/v1/airport/:id",controllers.api.v1.authController.authorizeAdmin ,controllers.api.v1.airportController.checkAirport,controllers.api.v1.airportController.getById);
apiRouter.post("/api/v1/airport",controllers.api.v1.authController.authorizeAdmin ,controllers.api.v1.airportController.create);
apiRouter.put("/api/v1/airport/:id",controllers.api.v1.authController.authorizeAdmin ,controllers.api.v1.airportController.checkAirport,controllers.api.v1.airportController.update);
apiRouter.delete("/api/v1/airport/:id",controllers.api.v1.authController.authorizeAdmin ,controllers.api.v1.airportController.checkAirport,controllers.api.v1.airportController.destroy);
