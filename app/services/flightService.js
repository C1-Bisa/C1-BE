...
module.exports = {
  ...
  async create(reqBody) {
    try {
    if(!reqBody.airline_id || !reqBody.airport_id || !reqBody.departure_date || !reqBody.departure_time || !reqBody.arrival_date || !reqBody.arrival_time || !reqBody.from || !reqBody.to || !reqBody.price || !reqBody.flight_class || !reqBody.description){
        return {
            status: "Failed",
  ...
  async update(id, reqBody) {
    try {
    const ticket = await flightRepository.update(id,{
        airline_id: reqBody.airline_id,
        airport_id: reqBody.airport_id,
        departure_date: reqBody.departure_date,
        departure_time: reqBody.departure_time,
